      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground google-sans max-w-2xl">
            Discover millions of books, manuscripts, and other digital resources
            ...
            {books.length > 0 ? (
                  ...
                  >
                    <div className="relative aspect-[3/4] overflow-hidden bg-muted">
                      <Image
                        src={
                          imageError[book.key]
                            ? "https://placehold.co/720x480?text=Cover+Not+Found"
                            : coverUrl
                        }
                        alt={title}
                        fill
              ...
              <div className="col-span-full flex h-96 flex-col items-center justify-center text-center">
                ...
                <p className="text-muted-foreground max-w-sm">
                  Access the world&apos;s most comprehensive open library and
                  find your next technical resource.
                </p>
              </div>
            )}
          </div>
