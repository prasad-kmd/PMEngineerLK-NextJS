...
export default function ResistorColorCode() {
  ...
  const result = useMemo(() => {
    ...
    if (resistance >= 1000000)
      formattedRes = (resistance / 1000000).toFixed(2) + " MΩ";
    else if (resistance >= 1000)
      formattedRes = (resistance / 1000).toFixed(2) + " kΩ";
      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Resistor Color Code Solver",
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Interactive visual calculator for 4, 5, and 6-band resistors. Select
            colors to decode the resistance value.
          </p>
        </div>
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          c.color,
                          selectedColors[bandIdx] === colorIdx
                            ? "ring-2 ring-primary ring-offset-2 ring-offset-background"
                            : "opacity-80 grayscale-[0.2] hover:grayscale-0 hover:opacity-100",
                        )}
                        title={c.name}
                      >
                        {c.name === "White" && (
