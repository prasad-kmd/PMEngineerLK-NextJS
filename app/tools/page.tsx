...
const mathTools = [
  ...
  },
  {
    ...
    description:
      "Comprehensive computational engine with support for trigonometric and algebraic functions.",
    icon: Calculator,
    color: "text-green-500",
    bgColor: "bg-green-500/10",
  },
...
const coreTools = [
  {
    ...
    description:
      "High-performance Markdown environment with real-time GitHub-flavored preview.",
    icon: Edit3,
    color: "text-blue-500",
    bgColor: "bg-blue-500/10",
  },
  {
    ...
    description:
      "Transform LaTeX syntax into standards-compliant MathML for web rendering.",
    icon: Replace,
    color: "text-purple-500",
    bgColor: "bg-purple-500/10",
  },
  {
    ...
    slug: "html-encoder",
    description:
      "HTML entity encoder/decoder for secure code presentation and XSS prevention.",
    icon: Code2,
    color: "text-orange-500",
    bgColor: "bg-orange-500/10",
  },
  {
    ...
    description:
      "LaTeX authoring environment with dynamic block mathematical rendering.",
    icon: Sigma,
    color: "text-pink-500",
...
const discoveryTools = [
  {
    ...
    slug: "../researches",
    description:
      "Access and search through millions of scholarly articles on arXiv.",
    icon: FlaskConical,
    color: "text-teal-500",
    bgColor: "bg-teal-500/10",
  },
  {
    ...
    slug: "../open-books",
    description:
      "Discover millions of books and digital resources from Open Library.",
    icon: Library,
    color: "text-blue-500",
    bgColor: "bg-blue-500/10",
  },
  {
    ...
    slug: "../feeds",
    description:
      "Stay updated with the latest engineering logs from external RSS feeds.",
    icon: Rss,
    color: "text-orange-500",
    bgColor: "bg-orange-500/10",
  },
  {
    ...
    slug: "../game-deal",
    description:
      "Search and compare the best game discounts across digital stores.",
    icon: Gamepad2,
    color: "text-rose-500",
    bgColor: "bg-rose-500/10",
  },
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-24 rounded-3xl border border-border/50 bg-card/30 p-8 text-center backdrop-blur-sm">
          ...
          <p className="mx-auto max-w-md text-muted-foreground text-sm font-local-inter">
            New professional utilities are being added regularly. Have a
            specific engineering need? Reach out via the feedback portal.
          </p>
        </div>
      </div>
      <AIContentIndicator />
