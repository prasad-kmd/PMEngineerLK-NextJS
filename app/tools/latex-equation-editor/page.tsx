      ...
      <div className="mx-auto max-w-4xl w-full">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Mathematical Formula Architect",
              href: "/tools/latex-equation-editor",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8 text-center lg:text-left">
          ...
          <p className="text-muted-foreground mt-1">
            Advanced LaTeX authoring environment with dynamic block mathematical
            rendering and formula templates.
          </p>
        </div>
          ...
          <div className="p-4 bg-muted/30 rounded-xl border border-border text-sm flex gap-3">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                <li>
                  Use <code className="bg-background px-1 rounded">^</code> for
                  exponents and{" "}
                  <code className="bg-background px-1 rounded">_</code> for
                  subscripts.
                </li>
                <li>
                  Fractions:{" "}
