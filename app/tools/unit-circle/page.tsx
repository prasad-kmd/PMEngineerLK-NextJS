      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Interactive trigonometric visualization of the unit circle, showing
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
              ...
              <CardContent className="flex flex-col items-center justify-center p-6">
                <svg
                  ...
                  height="300"
                  viewBox="0 0 300 300"
                  className="bg-background/20 rounded-full border border-border/50 shadow-inner"
                >
                  {/* Axes */}
                  <line
                    x1="0"
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-200 text-xs">
              ...
              <p>
                The unit circle is a circle with a radius of 1 centered at the
                origin (0,0). For any angle θ, the coordinates of the point on
                the circle are (cos θ, sin θ).
              </p>
            </div>
          </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <div className="p-3 rounded-lg bg-background/30 border border-border/30 text-center">
                    ...
                    <div className="font-mono font-bold">
                      {Math.abs(cos) < 0.0001 ? "N/A" : (1 / cos).toFixed(3)}
                    </div>
                  </div>
                  <div className="p-3 rounded-lg bg-background/30 border border-border/30 text-center">
                    <div className="text-[10px] uppercase text-muted-foreground mb-1">
                    ...
                    <div className="font-mono font-bold">
                      {Math.abs(sin) < 0.0001 ? "N/A" : (1 / sin).toFixed(3)}
                    </div>
                  </div>
                </div>
