      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Bolt Torque Chart",
              href: "/tools/bolt-torque-chart",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Standard metric torque specifications (Nm) for property classes
              8.8, 10.9, and 12.9.
            </p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-muted/50 border-b border-border">
                  ...
                  <th className="p-4 text-xs font-bold uppercase text-primary">
                    Class 8.8
                  </th>
                  <th className="p-4 text-xs font-bold uppercase text-orange-500">
                    Class 10.9
                  </th>
                  <th className="p-4 text-xs font-bold uppercase text-red-500">
                    Class 12.9
                  </th>
                </tr>
              </thead>
              <tbody>
                {filtered.map((row, i) => (
                  <tr
                    key={row.size}
                    className={`border-b border-border/50 transition-colors hover:bg-primary/5 ${i % 2 === 0 ? "bg-background/20" : ""}`}
                  >
                    ...
                    <td className="p-4 font-mono font-semibold text-orange-500/80">
                      {row.class109} Nm
                    </td>
                    <td className="p-4 font-mono font-semibold text-red-500/80">
                      {row.class129} Nm
                    </td>
                  </tr>
                ))}
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="flex items-start gap-3 p-4 rounded-lg bg-zinc-500/10 border border-zinc-500/20 text-[11px] text-zinc-300">
            ...
            <p>
              Torque values are for metric coarse threads and assume a friction
              coefficient of µ = 0.14 (dry assembly). Always refer to
          ...
          <Card className="bg-primary/5 border-primary/20 p-4 flex items-center gap-4">
            ...
            <div className="text-[11px]">
              ...
              <p className="text-muted-foreground">
                Values shown represent approximately 90% of the yield strength
                of the bolt.
              </p>
            </div>
          </Card>
