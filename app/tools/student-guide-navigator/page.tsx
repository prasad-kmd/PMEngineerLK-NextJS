      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-8">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-card/30 backdrop-blur-xl border border-primary/10 p-8 md:p-10 shadow-xl">
            ...
            <div className="relative z-10 max-w-3xl">
              <h1 className="mb-2 text-3xl md:text-4xl font-black mozilla-headline tracking-tighter bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex justify-between items-end">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-lg font-black text-primary mozilla-headline">
            ...
            <Card className="bg-gradient-to-br from-primary to-primary/80 border-none text-primary-foreground rounded-2xl shadow-lg shadow-primary/20 overflow-hidden relative group">
              ...
              <CardContent className="space-y-3 pb-5">
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-2xl font-black mozilla-headline tracking-tighter">
          ...
          <div className="w-full">
            <Tabs
              ...
              className="space-y-6"
            >
              <div className="sticky top-20 z-50 mb-12 flex flex-wrap justify-center gap-2 p-2 rounded-2xl bg-background/50 backdrop-blur-xl border border-border/50 shadow-sm">
                <TabsList className="flex flex-wrap justify-center w-full bg-transparent gap-2 h-auto">
                  {[
                    {
                      id: "dashboard",
                      label: "Dashboard",
                    ...
                    <TabsTrigger
                      key={item.id}
                      value={item.id}
                      className="px-4 py-2 text-[10px] md:text-xs font-bold uppercase tracking-wider rounded-lg transition-all hover:bg-primary/10 hover:text-primary text-muted-foreground local-jetbrains-mono data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:shadow-none"
                    >
                ...
                <div className="grid gap-8 lg:grid-cols-5">
                  <Card className="lg:col-span-3 rounded-[2.5rem] border-primary/10 overflow-hidden shadow-2xl bg-card/50 backdrop-blur-xl">
                    <CardHeader className="p-8 pb-0">
                      <CardTitle className="text-xl font-black mozilla-headline">
                        Credit Distribution
                      </CardTitle>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center gap-4 p-5 rounded-[1.5rem] bg-primary/5 border border-primary/10 group hover:border-primary/30 transition-all">
                          ...
                          <div>
                            ...
                            <p className="text-3xl font-black text-primary mozilla-headline">
                              {progressStats.totalCredits}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4 p-5 rounded-[1.5rem] bg-blue-500/5 border border-blue-500/10 group hover:border-blue-500/30 transition-all">
                          ...
                          <div>
                            ...
                            <p className="text-3xl font-black text-blue-500 mozilla-headline">
              ...
              <TabsContent value="planner" className="space-y-8">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 p-6 md:p-8 rounded-2xl border border-primary/10 bg-card/30 backdrop-blur-xl shadow-xl transition-all hover:bg-card/40">
                  <div className="space-y-1">
                    <h3 className="text-2xl font-black mozilla-headline flex items-center gap-3">
                  ...
                  <div className="lg:col-span-4 h-fit sticky top-20">
                    <Card className="rounded-2xl border-primary/10 overflow-hidden shadow-2xl bg-card/50 backdrop-blur-xl">
                      <CardHeader className="p-8 pb-4">
                        <CardTitle className="text-xl font-black mozilla-headline flex items-center gap-2">
        ...
        <div className="mt-24 p-8 md:p-12 rounded-2xl border border-primary/10 bg-card/40 backdrop-blur-2xl relative overflow-hidden group shadow-2xl transition-all duration-700 hover:border-primary/30">
          ...
          <div className="relative z-10 max-w-2xl">
            <h2 className="text-3xl font-black mozilla-headline mb-6 tracking-tight">
      ...
      <CardContent className="p-5 md:p-6">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-baseline gap-1">
            <span
              ref={valueRef}
              className="text-3xl font-black mozilla-headline tracking-tighter tabular-nums text-foreground"
            >
              {value}
            </span>
          </div>
    ...
    >
      <div className="p-4 space-y-3 flex-1 flex flex-col">
        <div className="flex justify-between items-start">
          <Badge
            variant="outline"
            className="font-local-jetbrains-mono border-primary/20 text-primary bg-primary/5 px-2 py-0.5 rounded-lg text-[10px]"
          >
            {course.code}
          </Badge>
