...
export default function MomentOfInertiaCalculator() {
  ...
  const [shape, setShape] = usePersistentState<string>(
    "moi-shape",
    "rectangle",
  );
      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            { label: "Tools", href: "/tools" },
            {
              ...
              href: "/tools/moment-of-inertia-calculator",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Compute Area Moment of Inertia (Ixx, Iyy) for standard
            cross-sections. Essential for structural analysis and beam
            deflection.
          </p>
        </div>
              ...
              <CardContent className="flex-1 flex flex-col justify-center space-y-6">
                ...
                <div className="p-4 rounded-lg border border-border/50 bg-background/30 mt-auto">
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    ...
                    <strong>Beam Deflection Calculator</strong> to analyze
