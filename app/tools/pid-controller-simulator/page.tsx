...
import { LineChart as ChartIcon, Sliders, Zap } from "lucide-react";
...
export default function PIDSimulator() {
  ...
  const simData = useMemo(() => {
    ...
    for (let t = 0; t < steps; t++) {
      ...
      const acceleration =
        (controlSignal - damping * velocity - spring * position) / mass;
      velocity += acceleration * dt;
      position += velocity * dt;

      if (t % 2 === 0) {
        // Downsample for smoother chart performance
        history.push({
          time: (t * dt).toFixed(2),
          position: position,
          setpoint: setpoint,
      ...
      <div className="mx-auto max-w-5xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "PID Controller Simulator",
              href: "/tools/pid-controller-simulator",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Interactive step-response simulator for tuning Proportional,
        ...
        <div className="grid gap-8 lg:grid-cols-12">
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="p-4 rounded-lg bg-violet-500/10 border border-violet-500/20 text-[11px] text-violet-200 space-y-2">
              ...
              <p>
                <strong>P:</strong> Faster response, but increases overshoot and
                steady-state error.
              </p>
              <p>
                <strong>I:</strong> Eliminates steady-state error, but adds
                oscillation.
              </p>
              <p>
                <strong>D:</strong> Predicts future error to dampen the system
