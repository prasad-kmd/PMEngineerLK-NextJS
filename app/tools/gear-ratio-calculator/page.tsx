...
import { Settings2, Info, Cog, ArrowRight, Activity } from "lucide-react";
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Analyze output speed and torque for gear trains, belt drives, or
            chain drives.
          </p>
        </div>
                  ...
                  <div className="flex items-center justify-around">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <Cog
                        ...
                        style={{
                          height: result
                            ? `${Math.min(64, Math.max(24, 24 * parseFloat(result.ratio)))}px`
                            : "40px",
                          width: result
                            ? `${Math.min(64, Math.max(24, 24 * parseFloat(result.ratio)))}px`
                            : "40px",
                          animationDuration: result
                            ? `${2 * parseFloat(result.ratio)}s`
                            : "2s",
                          animationDirection: "reverse",
                        }}
                      />
                      <span className="text-[9px] uppercase font-bold text-orange-500">
                        Driven
                      </span>
                    </div>
                  </div>
