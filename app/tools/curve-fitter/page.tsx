...
export default function CurveFitter() {
  const [data, setData] = usePersistentState<string>(
    "curve-data",
    "1, 2.1\n2, 3.9\n3, 6.2\n4, 8.1\n5, 10.3",
  );
      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Linear Curve Fitter",
              href: "/tools/curve-fitter",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Fit a linear or polynomial model to your data points using the least
            squares method.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-200 text-xs">
              ...
              <p>
                Regression analysis finds parameters that minimize the sum of
                squared residuals between observed data and the fitted curve.
              </p>
            </div>
          </div>
            ...
            <Card className="border-primary/20 bg-primary/5 h-full flex flex-col">
              ...
              <CardContent className="flex-1 flex flex-col justify-center space-y-6">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {results &&
                    Object.entries(results.params).map(([k, v]) => (
                      <div
                        key={k}
                        className="p-3 rounded-xl bg-background/50 border border-border/50 flex justify-between items-center"
                      >
                ...
                <div className="p-4 rounded-xl bg-background/50 border border-border/50 text-center">
                  ...
                  <div
                    className={`text-2xl font-bold tabular-nums ${results && parseFloat(results.r2) > 0.9 ? "text-green-500" : "text-amber-500"}`}
                  >
                    {results ? results.r2 : "--"}
                  </div>
