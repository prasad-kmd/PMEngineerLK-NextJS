      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Op-Amp Gain Calculator",
              href: "/tools/op-amp-gain-calculator",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Calculate gain and output voltage for Inverting and Non-Inverting
              ...
              <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="r1">
                      Input Resistor <InlineMath math="R_1" /> (kΩ)
                    </Label>
                    <Input
                      id="r1"
                      type="number"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="rf">
                      Feedback Resistor <InlineMath math="R_f" /> (kΩ)
                    </Label>
                    <Input
                      id="rf"
                      type="number"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="vin">
                      Input Voltage <InlineMath math="V_{in}" /> (V)
                    </Label>
                    <Input
                      id="vin"
                      type="number"
                ...
                <CardContent className="flex-1 flex flex-col justify-center space-y-12">
                  <div className="text-center">
                    <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-1">
                      Voltage Gain (<InlineMath math="A_v" />)
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-1">
                      Output Voltage (<InlineMath math="V_{out}" />)
                    </div>
                  ...
                  <div className="p-4 rounded-lg border border-border/50 bg-background/30 text-[11px] text-muted-foreground">
                    <p>
                      Note: Real-world Op-Amps are limited by their supply
                      voltage (Vcc/Vee). The output will clip if Vout exceeds
                      the supply rails.
                    </p>
                  </div>
                </CardContent>
