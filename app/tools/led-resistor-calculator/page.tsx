...
export default function LEDResistorCalculator() {
  ...
  const result = useMemo(() => {
    ...
    if (Vs <= Vf * N)
      return {
        error: "Source voltage must be greater than total forward voltage.",
      };
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Calculate the required resistance and power rating for LEDs
            connected in series.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="vs">
                    Source Voltage (<InlineMath math="V_s" />) [V]
                  </Label>
                  <Input
                    id="vs"
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor="vf">
                    LED Forward Voltage (<InlineMath math="V_f" />) [V]
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="if">
                    LED Forward Current (<InlineMath math="I_f" />) [mA]
                  </Label>
                  <Input
                    id="if"
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor="n">
                    Number of LEDs in Series (<InlineMath math="N" />)
                  </Label>
                  <Input
                    id="n"
                    type="number"
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-[11px] text-yellow-200">
              ...
              <div>
                <p className="font-bold mb-2 underline underline-offset-4 uppercase tracking-wider text-[10px]">
                  Ohm&apos;s Law Formula:
                </p>
                ...
                <p className="mt-2 leading-relaxed opacity-80">
                  Ensure <InlineMath math="V_s > (V_f \cdot N)" /> for the
                  circuit to function.
                </p>
              </div>
            </div>
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-4 rounded-xl bg-background/50 border border-border/50 text-center">
                        ...
                        <div className="text-xl font-semibold tabular-nums">
                          {result?.standardResistor
                            ? `${result.standardResistor} Ω`
                            : "--"}
                        </div>
                      </div>
                      <div className="p-4 rounded-xl bg-background/50 border border-border/50 text-center">
                    ...
                    <div className="p-4 rounded-lg border border-border/50 bg-background/30">
                      ...
                      <p className="text-[11px] text-muted-foreground">
                        Choose a resistor with at least double the calculated
                        power dissipation for long-term reliability. For{" "}
                        {result?.power}W, use at least a{" "}
                        {(parseFloat(result?.power || "0") * 2).toFixed(2)}W
                        rated resistor.
                      </p>
                    </div>
                  </>
