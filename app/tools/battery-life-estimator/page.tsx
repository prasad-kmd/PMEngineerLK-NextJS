...
import { Battery, Info, Clock, AlertTriangle } from "lucide-react";
      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            { label: "Tools", href: "/tools" },
            {
              ...
              href: "/tools/battery-life-estimator",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Estimate battery runtime based on capacity and load current with
            optional Peukert&apos;s Law compensation.
          </p>
        </div>
                  ...
                  {isPeukert && (
                    <div className="space-y-2 animate-in fade-in slide-in-from-top-2">
                      ...
                      <Input
                        ...
                        type="number"
                        value={peukertExp}
                        onChange={(e) => setPeukertExp(e.target.value)}
                        step="0.01"
                      />
                      <p className="text-[10px] text-muted-foreground">
                        Typically 1.05 to 1.3 for Lead Acid. Lithium is closer
                        to 1.0.
                      </p>
                    </div>
                  )}
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-green-500/10 border border-green-500/20 text-[11px] text-green-200">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2 text-xl">
                  <div>
                    <InlineMath math="\text{T}=\frac{\text{Capacity}}{\text{Current}}" />
                  </div>
                </div>
                <br />
                <p className="font-semibold text-xs">
                  Peukert&apos;s Law accounts for the fact that battery capacity
                  decreases as the rate of discharge increases.
                </p>
              </div>
            </div>
          </div>
