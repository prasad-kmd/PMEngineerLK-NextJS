      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "PCB Trace Width Calculator",
              href: "/tools/pcb-trace-width",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Calculate the required trace width for a given current capacity
              ...
              <CardContent className="flex-1 flex flex-col justify-center space-y-8">
                ...
                <div className="p-4 rounded-lg border border-border/50 bg-background/30">
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    It is generally recommended to add a 10-20% margin to the
                    calculated trace width for safety and manufacturing
                    tolerances.
                  </p>
                </div>
              </CardContent>
