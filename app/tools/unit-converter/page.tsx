      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Precision Unit Converter",
        ...
        <div className="mb-12 text-center lg:text-left">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed local-inter">
            Standardized metric and imperial unit conversions for engineering
            parameters.
          </p>
        </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-8 rounded-xl border border-blue-500/20 bg-blue-500/5 p-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Conversion factors are based on standard NIST values. For
                high-precision aerospace or medical applications, please verify
                with official IEEE-754 standards. Temperature conversions
                utilize absolute zero constants where applicable.
              </p>
            </div>
          </div>
        </div>
