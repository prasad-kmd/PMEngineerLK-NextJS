...
export default function DataTransformPage() {
  ...
  const handleHexDecode = () => {
    try {
      ...
      setOutput(
        chars.map((h) => String.fromCharCode(parseInt(h, 16))).join(""),
      );
    } catch {
      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Data Transformation Suite",
              href: "/tools/data-transform",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground leading-relaxed">
            Comprehensive Base64, Hex, and URL encoding/decoding utilities for
        ...
        <div className="space-y-6">
                  ...
                  <Tabs defaultValue="base64" className="w-full">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3 justify-center">
                      <TabsContent value="base64" className="m-0 flex gap-3">
                        <Button onClick={handleBase64Encode} className="gap-2">
                          Encode
                        </Button>
                        <Button
                      ...
                      <TabsContent value="url" className="m-0 flex gap-3">
                        <Button onClick={handleUrlEncode} className="gap-2">
                          Encode
                        </Button>
                        <Button
                      ...
                      <TabsContent value="hex" className="m-0 flex gap-3">
                        <Button onClick={handleHexEncode} className="gap-2">
                          Encode
                        </Button>
                        <Button
                      ...
                      <TabsContent value="binary" className="m-0 flex gap-3">
                        <Button onClick={handleBinaryEncode} className="gap-2">
                          Encode
                        </Button>
                      </TabsContent>
                    </div>
          ...
          <section className="rounded-2xl border border-primary/10 bg-primary/5 p-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              This transformation suite operates entirely within your browser.
              No data is sent to any server, ensuring the confidentiality of
              your technical data and credentials during the conversion process.
            </p>
          </section>
        </div>
      </div>
