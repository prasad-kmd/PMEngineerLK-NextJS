      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            { label: "Tools", href: "/tools" },
            {
              ...
              href: "/tools/beam-deflection-calculator",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Calculate maximum deflection for standard beam load cases using
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-[11px] text-indigo-200 italic">
              ...
              <div className="flex-1">
                <p className="font-semibold mb-2 text-xs">
                  Formula (
                  {type === "cantilever" ? "Cantilever" : "Simply Supported"}):
                </p>
                ...
                <p>
                  Assumes small deflections and linear elastic material
                  properties.
                </p>
              </div>
            </div>
