...
export const metadata: Metadata = {
  title: "Tailwind Labs | Engineering Workspace",
  description: "Interactive Tailwind CSS labs for building accent-aware UI patterns quickly.",
};
...
const labs = [
  {
    name: "Button LAB",
    slug: "button-lab",
    description: "Create, modify, and design accent-aware buttons using Tailwind CSS. Includes library and recipes.",
    icon: MousePointer2,
    color: "text-primary",
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-12">
          ...
          <p className="max-w-2xl text-lg text-muted-foreground leading-relaxed roboto">
            Interactive Tailwind CSS utilities and labs designed for building high-fidelity, 
            accent-aware UI patterns quickly.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {labs.map((lab) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className={`rounded-xl ${lab.bgColor} p-4 ${lab.color} shrink-0`}>
          ...
          <Card className="flex flex-col items-center justify-center border-dashed border-2 border-border/50 bg-muted/20 p-8 text-center backdrop-blur-sm">
            ...
            <h3 className="text-lg font-semibold text-muted-foreground google-sans">More Labs Coming</h3>
            <p className="text-xs text-muted-foreground/60 mt-1 local-inter">
              We are cooking more interactive utilities for layouts, typography, and complex components.
            </p>
          </Card>
        </div>
        ...
        <div className="mt-24 rounded-3xl border border-primary/10 bg-primary/5 p-8 text-center backdrop-blur-sm">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground text-sm font-local-inter">
            Building modern web interfaces requires rapid prototyping and consistent design tokens. 
            Tailwind Labs provides a sandbox to experiment with UI patterns that automatically 
            inherit your project's accent theme, ensuring seamless integration.
          </p>
        </div>
      </div>
    </div>
