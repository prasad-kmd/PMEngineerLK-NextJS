        ...
        <div className="min-h-screen pb-20 px-6 lg:px-8 pt-12 bg-background">
            <div className="mx-auto max-w-7xl">
                ...
                <header className="mb-12 text-center print:hidden">
                    ...
                    <h1 className="text-4xl font-bold tracking-tight lg:text-5xl mb-4 mozilla-headline">Resume Architect</h1>
                            ...
                            >
                                ...
                                <div className="px-10 pt-20 pb-10">
                                    ...
                                    <div className="grid gap-10">
                                        ...
                                        {resume.summary && (
                                            <section>
                                                <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-4 google-sans pb-1 border-b" style={{ color: "rgba(59, 130, 246, 0.7)", borderColor: "#e2e8f0" }}>Professional Summary</h3>
                                        ...
                                        {/* Experience */}
                                        <section>
                                            <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-6 google-sans pb-1 border-b" style={{ color: "rgba(59, 130, 246, 0.7)", borderColor: "#e2e8f0" }}>Work Experience</h3>
                                        ...
                                        <div className="grid grid-cols-3 gap-10">
                                            <div className="col-span-2 space-y-10">
                                                {/* Education */}
                                                <section>
                                                    <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-6 google-sans pb-1 border-b" style={{ color: "rgba(34, 197, 94, 0.7)", borderColor: "#e2e8f0" }}>Education</h3>
                                                ...
                                                {/* Projects */}
                                                <section>
                                                    <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-6 google-sans pb-1 border-b" style={{ color: "rgba(168, 85, 247, 0.7)", borderColor: "#e2e8f0" }}>Key Projects</h3>
                                            ...
                                            <div className="space-y-10">
                                                {/* Skills */}
                                                <section>
                                                    <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-4 google-sans pb-1 border-b" style={{ color: "rgba(249, 115, 22, 0.7)", borderColor: "#e2e8f0" }}>Technical Skills</h3>
                                                ...
                                                {/* Certifications */}
                                                <section>
                                                    <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-4 google-sans pb-1 border-b" style={{ color: "rgba(14, 165, 233, 0.7)", borderColor: "#e2e8f0" }}>Certifications</h3>
