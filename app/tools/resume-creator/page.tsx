      ...
      <div className="mx-auto max-w-7xl">
        ...
        <header className="mb-12 text-center print:hidden">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Craft a high-impact, professional resume with real-time preview and
        ...
        <div className="lg:hidden p-6 bg-amber-500/10 border border-amber-500/20 rounded-xl mb-8 print:hidden">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            This tool is optimized for large screens to ensure pixel-perfect
            layout and professional PDF generation. Please use a desktop for the
            best experience.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-8 print:hidden">
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
                <CardHeader className="flex flex-row items-center justify-between">
                  <CardTitle className="text-lg flex items-center gap-2 google-sans">
          ...
          <div className="relative">
            <div ref={resumeRef} className="print:block print:static">
              ...
              >
                ...
                <div
                  className="h-40 flex items-end px-10 pb-6"
                  style={{
                    background:
                ...
                >
                  <div
                    className="h-32 w-32 rounded-2xl flex items-center justify-center -mb-16 overflow-hidden shadow-xl"
                    style={{
                      backgroundColor: "#ffffff",
                  ...
                  <div className="ml-8 mb-[-10px] text-white overflow-hidden">
                    <h2 className="text-4xl font-bold amoriaregular uppercase tracking-tight leading-none mb-2 wrap-break-word">
                      {resume.name}
                    </h2>
                    <p
                      className="text-xl font-semibold google-sans wrap-break-word"
                      style={{ color: "#3b82f6" }}
                    >
                      {resume.role}
                    </p>
                ...
                <div className="px-10 pt-20 pb-10">
                  <div
                    className="grid grid-cols-2 gap-y-3 mb-10 text-xs font-medium uppercase tracking-wider p-4 rounded-xl overflow-hidden"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 overflow-hidden">
                      <MapPin
                        ...
                        style={{ color: "#3b82f6" }}
                      />{" "}
                      <span className="wrap-break-word">{resume.location}</span>
                    </div>
                    {resume.website && (
                      <div className="flex items-center gap-2 overflow-hidden">
                        <Globe
                    ...
                    {resume.github && (
                      <div className="flex items-center gap-2 overflow-hidden">
                        <Github
                          ...
                          style={{ color: "#3b82f6" }}
                        />{" "}
                        <span className="break-all">{resume.github}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="grid gap-10">
                    ...
                    {resume.summary && (
                      <section>
                        <h3
                          className="text-sm font-bold uppercase tracking-[0.2em] mb-4 google-sans pb-1 border-b"
                          style={{
                    ...
                    <section>
                      <h3
                        className="text-sm font-bold uppercase tracking-[0.2em] mb-6 google-sans pb-1 border-b"
                        style={{
                          color: "rgba(59, 130, 246, 0.7)",
                          borderColor: "#e2e8f0",
                        }}
                        ...
                        {resume.experiences.map((exp, i) => (
                          <div key={i} className="relative pl-6">
                            ...
                            <div className="flex justify-between items-start mb-1 gap-4">
                              <h4
                                className="font-bold text-lg flex-1 wrap-break-word"
                                style={{ color: "#1e293b" }}
                              >
                                {exp.role}
                              </h4>
                            ...
                            <p
                              className="text-sm font-bold mb-2 wrap-break-word"
                              style={{ color: "#3b82f6" }}
                            >
                              {exp.company}
                            </p>
                        ...
                        <section>
                          ...
                          <div className="space-y-4">
                            {resume.projects.map((p, i) => (
                              <div
                                key={i}
                                className="p-4 rounded-xl border border-dashed overflow-hidden"
                                style={{
                              ...
                              >
                                <div className="flex justify-between items-center mb-1 gap-2">
                                  <h4
                                    className="text-sm font-bold flex-1 wrap-break-word"
                                    style={{ color: "#1e293b" }}
                                  >
                                    {p.name}
                                  </h4>
                ...
                <div
                  className="px-10 py-6 flex justify-between items-center text-[10px] font-mono border-t"
                  style={{
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, #3b82f6, #22c55e, #a855f7, #f97316)",
                  }}
                />
              </Card>
            </div>
