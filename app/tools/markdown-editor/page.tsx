      ...
      <div className="mx-auto max-w-6xl w-full flex-1 flex flex-col">
        <Breadcrumbs
          items={[
            ...
            {
              label: "Technical Document Editor",
        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              High-performance Markdown environment with real-time
              GitHub-flavored preview and direct export capabilities.
            </p>
          </div>
        ...
        <div className="flex-1 grid gap-6 md:grid-cols-1 lg:grid-cols-2 min-h-[500px]">
          {(view === "edit" || view === "both") && (
            <div
              className={`flex flex-col h-full ${view === "edit" ? "lg:col-span-2" : ""}`}
            >
              <textarea
                value={markdown}
          ...
          {(view === "preview" || view === "both") && (
            <div
              className={`flex flex-col h-full ${view === "preview" ? "lg:col-span-2" : ""}`}
            >
