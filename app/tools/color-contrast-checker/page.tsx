...
import { CheckCircle2, XCircle, Info, Palette } from "lucide-react";
...
export default function ColorContrastChecker() {
  const [fgColor, setFgColor] = usePersistentState<string>(
    "contrast-fg",
    "#3B82F6",
  );
  const [bgColor, setBgColor] = usePersistentState<string>(
    "contrast-bg",
    "#020617",
  );
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Verify WCAG 2.1 compliance for foreground and background color
            combinations.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-200 text-xs">
              ...
              <p>
                The WCAG success criteria ensure that content is accessible to
                people with moderately low vision. Normal text requires 4.5:1,
                while large text (18pt+) requires 3:1.
              </p>
            </div>
          </div>
            ...
            <Card className="border-primary/20 bg-primary/5 h-full flex flex-col">
              ...
              <CardContent className="flex-1 flex flex-col justify-center space-y-6">
                ...
                <div className="p-4 rounded-lg border border-border/50 bg-background/30 mt-auto">
                  <h4 className="text-[10px] font-bold uppercase mb-2">
                    Standard Thresholds
                  </h4>
...
function ComplianceRow({ label, pass }: { label: string; pass: boolean }) {
  return (
    <div className="flex justify-between items-center p-3 rounded-lg bg-background/30 border border-border/30">
      ...
      <div
        className={`flex items-center gap-2 font-bold ${pass ? "text-green-500" : "text-red-500"}`}
      >
        {pass ? (
