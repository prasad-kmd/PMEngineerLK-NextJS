...
export default function PCBImpedanceCalculator() {
  const [type, setType] = usePersistentState<string>(
    "pcb-imp-type",
    "microstrip",
  );
  const [dielectric, setDielectric] = usePersistentState<string>(
    "pcb-imp-er",
    "4.4",
  ); // FR-4
      ...
      <div className="mx-auto max-w-4xl">
        <Breadcrumbs
          items={[
            ...
            {
              label: "PCB Impedance Calculator",
              href: "/tools/pcb-impedance-calculator",
              active: true,
            },
          ]}
          className="mb-8"
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Calculate microstrip and stripline characteristic impedance for
          ...
          <div className="space-y-6">
            <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="dielectric">
                    Dielectric Constant (<InlineMath math="\epsilon_r" />)
                  </Label>
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-200 text-xs">
              ...
              <div>
                <p className="font-bold mb-1 underline underline-offset-4">
                  Formula Info:
                </p>
                ...
                <ul className="list-disc ml-4 mt-1 space-y-0.5 text-[10px] opacity-80">
                  <li>
                    <InlineMath math="0.1 < w/h < 3.0" />
                  </li>
                  <li>
                    <InlineMath math="1 < \epsilon_r < 15" />
                  </li>
                </ul>
              </div>
            </div>
              ...
              <CardContent className="flex-1 flex flex-col justify-center space-y-8">
                ...
                <div className="p-4 rounded-lg border border-border/50 bg-background/30">
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    Standard high-speed designs usually target 50Ω for
                    single-ended signals and 100Ω for differential pairs. Adjust
                    width or height to match your target impedance.
                  </p>
                </div>
              </CardContent>
            </Card>
