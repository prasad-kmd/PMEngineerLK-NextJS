...
const title = "Now";
const description =
  "A snapshot of what I'm currently focused on - learning, building, and reading.";
        ...
        <div className="space-y-12">
          <section className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-primary/20 before:rounded-full">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                My primary focus is on refining this engineering portfolio and
                documentation platform. I&apos;m implementing advanced tools
                like a LaTeX to MathML converter and a scientific calculator to
                make it a true workspace.
              </p>
              <p>
                I&apos;m also working on a mechatronics project involving
                automated waste segregation systems, applying my mechanical
                design and electronic integration skills.
              </p>
            </div>
          </section>
          ...
          <section className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-blue-500/20 before:rounded-full">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Diving deeper into <strong>Next.js 15</strong> and{" "}
                <strong>Tailwind CSS 4</strong> to leverage the latest web
                technologies for technical documentation.
              </p>
              <p>
                Studying <strong>Control Systems</strong> and{" "}
                <strong>Robotics Kinematics</strong> as part of my engineering
                degree at OUSL.
              </p>
            </div>
          </section>
          ...
          <section className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-amber-500/20 before:rounded-full">
            ...
            <h2 className="text-2xl font-bold mb-4 philosopher">
              Side Projects
            </h2>
            <ul className="list-disc ml-4 space-y-2 text-muted-foreground">
              ...
              <li>
                Writing technical tutorials for fellow engineering students.
              </li>
            </ul>
          </section>
          ...
          <section className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-green-500/20 before:rounded-full">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Currently based in Colombo, Sri Lanka. When I&apos;m not at my
              desk, I&apos;m likely exploring the outdoors, reading a book on
              philosophy, or enjoying a good cup of Ceylon tea.
            </p>
          </section>
        </div>

        <footer className="mt-20 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          This is a &quot;now page&quot;, and you should{" "}
          <SafeLink
