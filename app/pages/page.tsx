...
const mainPages = [
  ...
  },
  {
    ...
    href: "/wiki",
    description: "A structured, searchable collection of engineering concepts and best practices.",
    icon: Book,
    color: "text-blue-500",
    bgColor: "bg-blue-500/10",
  },
  {
    name: "Open Source",
    href: "/open-source",
    description: "Showcase of my GitHub repositories, contribution guides, and releases.",
    icon: Github,
  ...
  },
  {
    name: "Downloads",
    href: "/resources",
    description: "Central repository for CAD files, code examples, and datasheets.",
    icon: FileArchive,
    color: "text-emerald-500",
    bgColor: "bg-emerald-500/10",
  },
  {
    name: "Cheat Sheets",
    href: "/cheat-sheets",
    description: "Printable PDF-style reference pages for quick engineering lookups.",
    icon: Printer,
    color: "text-orange-500",
    bgColor: "bg-orange-500/10",
  },
  {
    name: "Reading List",
    href: "/reading-list",
    description: "Curated books, papers, and articles with personal annotations.",
    icon: BookMarked,
    color: "text-purple-500",
    bgColor: "bg-purple-500/10",
  },
  {
    name: "Glossary",
    href: "/glossary",
    description: "Definitions of technical terms in mechatronics and mechanical engineering.",
    icon: Hash,
    color: "text-cyan-500",
    bgColor: "bg-cyan-500/10",
  },
  {
    name: "Style Guide",
    href: "/style-guide",
    description: "Visual brand assets, color palette, and typography guidelines.",
    icon: Palette,
    color: "text-pink-500",
    bgColor: "bg-pink-500/10",
  },
  {
    name: "Global Search",
    href: "/search",
    description: "Dedicated search page for finding any content across the platform.",
    icon: Search,
    color: "text-indigo-500",
    bgColor: "bg-indigo-500/10",
  },
