...
export const metadata = {
  title: "About Our Project | OUSL Engineering",
  description: "Learn more about our collaborative engineering mission, approach, and project roadmap.",
}
...
export default function AboutPage() {
  return (
    <div className="min-h-screen pb-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-border bg-muted/30 px-6 py-24 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="mb-6 text-4xl font-bold tracking-tight lg:text-6xl amoriaregular">
            About <span className="text-primary">Our Project</span>
          </h1>
          <p className="text-lg text-muted-foreground leading-relaxed">
            A collaborative undergraduate engineering initiative focused on identifying and solving real-world challenges in Sri Lanka through innovative mechanical and mechatronics solutions.
          </p>
        </div>
      </section>
