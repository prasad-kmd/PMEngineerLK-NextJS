    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4 philosopher">
              General Information
            </h2>
            <p>
              The information provided on this engineering documentation
              platform is for general informational and educational purposes
          ...
          <section>
            ...
            <p>
              The site cannot and does not contain engineering advice. The
              engineering information is provided for general informational and
              ...
              professionals. We do not provide any kind of engineering advice.
          ...
          <section>
            ...
            <p>
              ...
              contained in this site has been obtained from reliable sources, we
              are not responsible for any errors or omissions, or for the
