        ...
        <div className="p-8 rounded-3xl border border-border bg-card/50 backdrop-blur-md shadow-2xl mb-8 relative overflow-hidden group">
          ...
          {!session ? (
            <div className="relative z-10">
              ...
              <h2 className="text-xl font-bold mb-3 amoriaregular">
                Administrator Access Only
              </h2>
              <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
                This section of the workspace contains sensitive project
                roadmaps and internal configurations. Please sign in with an
                authorized account.
              </p>
              <Link
                href="/sign-in"
            ...
            <div className="relative z-10">
              ...
              <div className="mb-6">
                <p className="text-xs text-muted-foreground uppercase tracking-tighter mb-1 font-mono">
                  Signed in as
                </p>
              ...
              <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
                Your current technical role does not have the permissions
                required to access this endpoint. Please contact the system
