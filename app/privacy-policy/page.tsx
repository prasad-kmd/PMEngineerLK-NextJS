...
const cookieData = {
  ...
  bookmarks: {
    ...
    type: "Local Storage",
    purpose:
      'Stores the IDs of blog posts you have marked as "Saved" to create a personal reading list.',
    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="mx-auto max-w-6xl px-6 py-12 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-border pb-8 mb-12 gap-4">
          <div>
            <h2 className="text-3xl font-bold philosopher mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="group p-6 rounded-2xl border border-border bg-card hover:border-primary/50 transition-all hover:shadow-lg">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              No 3rd party analytics or pixels.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-20">
          <div>
            <h3 className="text-2xl font-bold philosopher mb-6 text-foreground">
              Where does your data go?
            </h3>
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Most websites silently beam your data to external servers and
              advertising networks. We took a different path. We utilize{" "}
              <strong className="text-foreground">client-side storage</strong>{" "}
              to keep your preferences under your control.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1 google-sans">
                    100% Client-Side
                  </h4>
                  <p className="text-muted-foreground text-sm">
                    Theme modes and bookmarks are saved in your browser, not our
                    database.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    No connections to Google Analytics, Meta Pixels, or obscure
                    ad trackers.
                  </p>
                </div>
              </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            <h3 className="text-2xl font-bold philosopher mb-2">
              Storage Inspector
            </h3>
            <p className="text-muted-foreground capitalize">
              click to inspect the functional data we keep on your machine
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1 space-y-3">
              ...
              <button
                disabled
                className="w-full text-left p-4 rounded-xl border border-border bg-card opacity-50 flex items-center justify-between group cursor-not-allowed"
              >
                <div className="flex items-center gap-3">
              ...
              {selectedCookie ? (
                <div className="w-full animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <div className="flex items-center gap-4 mb-6">
                    <div
                      className={cn(
                        "p-4 rounded-2xl",
                        cookieData[selectedCookie].bgColor,
                        cookieData[selectedCookie].color,
                      )}
                    >
                      {(() => {
                    ...
                    <div>
                      <h4 className="text-2xl font-bold philosopher">
                        {cookieData[selectedCookie].title}
                      </h4>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="p-4 rounded-xl bg-card border border-border">
                      ...
                      <p className="text-xs font-mono bg-muted p-1 border rounded w-fit">
                        {cookieData[selectedCookie].key}
                      </p>
                    </div>
                    <div className="p-4 rounded-xl bg-card border border-border">
                      <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">
                      ...
                      <p className="text-sm font-medium text-foreground">
                        {cookieData[selectedCookie].type}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <section>
                      <h5 className="text-sm font-bold text-foreground mb-2 google-sans">
                        Purpose of Collection
                      </h5>
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        {cookieData[selectedCookie].purpose}
                      </p>
                    </section>
                    <section>
                      <h5 className="text-sm font-bold text-foreground mb-2 google-sans">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        {cookieData[selectedCookie].privacy}
                      </p>
                    </section>
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground max-w-xs mx-auto">
                    Select a storage item on the left to inspect its technical
                    details and privacy impact.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground">
              Our architectures are designed to respect both local and
              international laws.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "We operate in accordance with the Personal Data Protection Act (PDPA) No. 9 of 2022. By not collecting personal identification, we exceed the Act's requirements for data minimization and privacy by design.",
              },
              {
                id: "gdpr",
                title: "International Standards (GDPR)",
                body: "While we are a Sri Lankan entity, we follow global best practices. Our 'Zero-Tracking' stance means we don't process data belonging to EU citizens, ensuring a boundary-less respect for privacy.",
              },
              {
                id: "withdrawal",
                title: "Right to Withdraw Consent",
                body: "Because all data lives in your browser, your right to delete is absolute. Clearing your browser's local storage or cache instantly and permanently removes all data associated with this site.",
              },
            ].map((item) => (
              <div
                key={item.id}
              ...
              >
                ...
                >
                  <span className="font-bold text-foreground google-sans">
                    {item.title}
                  </span>
                  <ChevronDown
                    className={cn(
