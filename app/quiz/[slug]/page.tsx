        ...
        <article className="min-w-0">
          <header className="mb-8 border-b border-border pb-8">
            <div className="flex flex-wrap items-center gap-2 mb-4">
               {quiz.tags?.map(tag => (
                 <Badge key={tag} variant="secondary" className="text-[10px] uppercase tracking-wider px-2">
                   {tag}
                 </Badge>
               ))}
            </div>
            <h1 className="mb-4 text-4xl font-bold text-balance lg:text-5xl font-google-sans">{quiz.title}</h1>
