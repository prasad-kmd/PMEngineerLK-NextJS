...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  const entry = getContentItem("diary", params.slug)
...
export default function DiaryEntryPage({ params }: { params: { slug: string } }) {
  const entry = getContentItem("diary", params.slug)
  ...
  return (
    <div className="min-h-screen px-6 py-12 lg:px-8 diary_item img_grad_pm">
