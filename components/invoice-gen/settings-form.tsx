...
const SectionHeader = ({
  ...
  <div className="flex items-start gap-4 mb-8">
    ...
    <div>
      <h2 className="text-xl font-bold google-sans tracking-tight">{title}</h2>
...
export function SettingsForm({ initialData }: SettingsFormProps) {
  ...
  return (
    <form
      ...
      className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-in fade-in slide-in-from-bottom-4 duration-700 relative"
    >
      {/* Left Column */}
