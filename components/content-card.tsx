...
export function ContentCard({ post, basePath }: ContentCardProps) {
  ...
  const hasImage = !!(post.thumbnail || post.firstImage);
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col p-4 md:p-6">
        ...
        <div className="grow overflow-hidden mt-1 md:mt-0">
          ...
          {post.description && (
            <p
              ...
              ${hasImage ? "text-gray-300" : "text-muted-foreground"}
            `}
            >
              {post.description}
            </p>
        ...
        <div
          ...
          ${hasImage ? "border-white/10" : "border-border/50"}
        `}
        >
            ...
            <div className="flex items-center gap-3">
              {post.rTime && (
                <div
                  ...
                  ${hasImage ? "text-gray-400" : "text-muted-foreground"}
                `}
                >
