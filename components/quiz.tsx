          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <p className="text-muted-foreground font-google-sans">
              {score === questions.length ? "Perfect score! You're an expert." :
               score >= questions.length / 2 ? "Great job! You have a good understanding." :
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  !isAnswered && "hover:border-primary/40 hover:bg-primary/5 active:scale-[0.98]",
                  ...
                  isAnswered && isWrong && "border-red-500 bg-red-500/10 text-red-700 dark:text-red-400",
                  isAnswered && !isCorrect && !isWrong && "opacity-40 grayscale-[0.5]",
                  !isSelected && !isAnswered && "border-transparent bg-muted/50"
                )}
              >
                <div className="flex items-center gap-3">
                  <span className={cn(
                    ...
                    isAnswered && isWrong && "border-red-500 bg-red-500 text-white"
                  )}>
                ...
                {isAnswered && isWrong && <XCircle className="h-5 w-5 shrink-0 text-red-500" />}
              </button>
            )
          })}
        </div>
