    ...
    >
      ...
      <div className="relative z-20 flex h-full items-center px-6 md:px-12 lg:px-20 pb-32 lg:pb-0">
        <div className="max-w-4xl text-foreground">
          <div className="flex items-center gap-3 mb-6 animate-in fade-in slide-in-from-left-4 duration-700 font-bold local-inter">
          ...
          <h1 className="text-5xl md:text-8xl font-black tracking-tighter mb-8 leading-none uppercase animate-in fade-in slide-in-from-bottom-4 duration-700 amoriaregular text-balance">
            {title}
          </h1>
          ...
          <div className="flex items-center gap-6 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            ...
            <span className="text-muted-foreground font-bold uppercase tracking-widest text-[10px] px-3 py-1.5 rounded-lg border border-border/10 bg-muted/20 backdrop-blur-md google-sans">
              TMDB Popularity
            </span>
          </div>

          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl leading-relaxed line-clamp-3 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200 local-inter">
          ...
          <div className="flex flex-wrap items-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            <Link
              ...
              className="bg-primary text-primary-foreground px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs flex items-center gap-3 hover:scale-105 transition-all shadow-xl shadow-primary/20 hover:bg-primary/90 noto-sans-display"
            >
        ...
        <div className="mx-auto flex max-w-full items-center justify-center gap-3 overflow-x-auto pb-4 scrollbar-hide">
          {items.map((item, index) => (
            ...
            >
              <span
                className={cn(
                  "text-[9px] font-black uppercase tracking-[0.2em] mb-1.5 transition-colors space-mono",
                  index === currentIndex
                    ? "text-primary"
              ...
              <span className="text-xs font-black text-foreground line-clamp-1 uppercase tracking-tight local-inter">
