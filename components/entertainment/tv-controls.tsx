    ...
    <div className="flex flex-col gap-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest google-sans">
            Select Season
          </label>
          <div className="flex flex-wrap gap-2">
            {show.seasons.map((season) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg border transition-all text-sm font-bold cursor-pointer google-sans ${
            ...
            {Array.from({ length: totalEpisodes }, (_, i) => i + 1).map(
              (episode) => (
                <button
                  ...
                  className={`w-10 h-10 flex items-center justify-center rounded-lg border transition-all text-sm font-bold cursor-pointer google-sans ${
